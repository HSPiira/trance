...
const resources = [
    ...
    },
    {
        ...
        date: 'May 20, 2023',
        readTime: '9 min read',
        tags: ['trauma', 'care', 'mental health'],
        likes: 0,
        comments: 0,
        bookmarked: false,
        url: '#',
...
export default function CounsellorResourcesPage() {
    ...
    useEffect(() => {
        // Filter resources based on search query, active category, and status
        ...
        setCurrentPage(1)
    }, [activeCategory, searchQuery, sortBy, statusFilter])
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Manage and create resources to support your clients' mental health journey
                        </p>
                    </div>
                    <Dialog open={showAddDialog} onOpenChange={setShowAddDialog}>
                        ...
                        <DialogContent className="sm:max-w-[600px]">
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    Create a new resource to share with your clients.
                                </DialogDescription>
                            </DialogHeader>
...
interface CounsellorResourceCardProps {
    resource: {
        id: number
        title: string
        description: string
...
function CounsellorResourceCard({ resource, onBookmark }: CounsellorResourceCardProps) {
    return (
        <Card className="overflow-hidden">
            <div className="relative h-48 w-full">
                ...
                {resource.status === 'draft' && (
                    <div className="absolute left-2 top-2 rounded bg-yellow-500/80 px-2 py-1 text-xs text-yellow-950 backdrop-blur-sm">
                        Draft
                    </div>
                )}
            </div>
            <CardHeader className="space-y-1 p-4">
                <div className="flex items-center gap-2">
                    ...
                    <Badge variant={resource.status === 'published' ? 'default' : 'secondary'} className="ml-auto">
...
function CounsellorResourceListItem({ resource, onBookmark }: CounsellorResourceCardProps) {
    return (
        <Card className="overflow-hidden">
            <div className="flex flex-col md:flex-row">
                <div className="relative h-32 w-full md:w-36">
                    ...
                    {resource.status === 'draft' && (
                        <div className="absolute left-1 top-1 rounded bg-yellow-500/80 px-1.5 py-0.5 text-xs text-yellow-950 backdrop-blur-sm">
                            Draft
                        </div>
                    )}
                </div>
                <div className="flex flex-1 flex-col">
                    <CardHeader className="space-y-1 p-2">
                        <div className="flex items-center gap-1">
                            ...
                            <Badge variant={resource.status === 'published' ? 'default' : 'secondary'} className="ml-auto text-xs">
                                {resource.status === 'published' ? 'Published' : 'Draft'}
                            </Badge>
                        </div>
