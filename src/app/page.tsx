    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-sky-50">
      ...
      <section className="py-16 px-6 md:px-10 lg:px-20 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <p className="mt-6 text-xl text-gray-600">
            Connect with professional counselors, track your progress, and take control of your mental wellbeing with our comprehensive counseling platform.
          </p>
      ...
      <section id="features" className="py-20 px-6 md:px-10 lg:px-20 bg-white">
        <div className="max-w-4xl mx-auto text-center mb-16">
          <h2 className="text-3xl font-bold text-gray-900">Comprehensive Mental Health Support</h2>
          <p className="mt-4 text-xl text-gray-600">
            Our platform provides everything you need for your mental health journey.
          </p>
        </div>
      ...
      <section id="how-it-works" className="py-20 px-6 md:px-10 lg:px-20 bg-gradient-to-b from-sky-50 to-white">
        <div className="max-w-4xl mx-auto text-center mb-16">
          <h2 className="text-3xl font-bold text-gray-900">How It Works</h2>
          <p className="mt-4 text-xl text-gray-600">
            Start your journey to better mental health in just a few simple steps.
          </p>
        </div>
      ...
      <section id="testimonials" className="py-20 px-6 md:px-10 lg:px-20 bg-white">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <p className="mt-4 text-xl text-gray-600">
            Real stories from people who have found support and healing through our platform.
          </p>
        </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-semibold text-white">Hope Counseling</span>
            </div>
            <p className="text-sm text-gray-400">
              Providing accessible mental health support for everyone, everywhere.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#testimonials" className="text-sm hover:text-white">Testimonials</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#" className="text-sm hover:text-white">FAQs</Link></li>
              <li><Link href="#" className="text-sm hover:text-white">Support</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#" className="text-sm hover:text-white">Terms of Service</Link></li>
              <li><Link href="#" className="text-sm hover:text-white">Cookie Policy</Link></li>
            </ul>
          </div>
        </div>

        <div className="max-w-7xl mx-auto border-t border-gray-800 mt-10 pt-8 text-center">
          <p className="text-sm text-gray-500">© {new Date().getFullYear()} Hope Counseling. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
